...
from game.views import GameCreateView, GameUpdateView, GameDetailView, GameListView, GameSearchView, \
    update_like, deleteGame
...
urlpatterns = [
    ...
    path('delete/<int:pk>/', deleteGame, name='delete'),
